$(document).ready( function () {
  ...
  select.change( () => {
    ...
    const filteredIcons = filterIcon(coloredIcons , selected);
    printIcons(filteredIcons , fonticons);
  });
  ...
  //OPTIONS GENERATED BY TYPE
  function genOption(types , select) {
    types.forEach( (options) => {
      select.append(`<option value='${options}'>${options}</option>`);
    });
  };
